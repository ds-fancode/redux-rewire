...
export {useRewireState as useRewireStateDeprecated} from './hooks/use-rewire-state'
...
export {sharedStoreSelector as sharedStoreSelectorDeprecated} from './helper/shared-store-selector'
